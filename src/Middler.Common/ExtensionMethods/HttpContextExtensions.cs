...
namespace doob.Middler.Common.ExtensionMethods
{
    public static class HttpContextExtensions
    {
        ...
        public static Task Content(this HttpContext context, string content, string contentType, Encoding contentEncoding)
        {
            ...
            mediaTypeHeaderValue.Encoding = contentEncoding;
            return context.Content(content, mediaTypeHeaderValue);
        }

        public static Task Content(this HttpContext context, string content, MediaTypeHeaderValue? contentType = null)
        {
